                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller') ? 'show' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('seller.dashboard.index') }}">
                        ...
                        <!-- Pages -->
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/transaction/*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                <i class="tio-shopping-cart nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    Admin Payment
                            ...
                            @php($sellerId = auth('seller')->id())
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('seller/transaction/*') ? 'block' : 'none' }}">

                                <li class="nav-item {{ Request::is('seller/transaction/list') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('seller.transaction.list') }}" title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        All Invoices
                                    </a>
                                </li>
                                ...
                                <li class="nav-item {{ Request::is('seller/transaction/list') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('seller.transaction.list', ['status' => 'pending']) }}"
                                       title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        Pending Invoices
                                    </a>
                                ...
                                <li class="nav-item {{ Request::is('seller/transaction/list') ? 'active' : '' }}">
                                    <a class="nav-link "
                                       href="{{ route('seller.transaction.list', ['status' => 'requested']) }}" title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        Requested Invoices
                                    </a>
                                </li>
                        ...
                        {{-- <li class="navbar-vertical-aside-has-menu {{Request::is('seller/transaction/list')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                            href="{{route('seller.transaction.list')}}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/reviews/list*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('seller.reviews.list') }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/messages*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('seller.messages.chat') }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/shop*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('seller.shop.view') }}">
                                ...
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ \App\CPU\translate('Account & Settings') }}
                                </span>
                            </a>
                        </li>
