...
<section class="container">
    <div class="setionPaddingTop setionPaddingBottom">
        <img src="{{ asset('public/assets/front-end') }}/img/sslCommarce.png" alt="">
    </div>
</section>
        ...
        <div
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">{{\App\CPU\translate('about_us')}}</h6>
                    <ul class="widget-list" style="padding-bottom: 10px">
                        ...
                        <li class="widget-list-item "><a class="widget-list-link"
                            href="{{route('disclaimer')}}">{{\App\CPU\translate('Disclaimer')}}</a>
                        </li>
                        <li class="widget-list-item "><a class="widget-list-link"
                            href="{{route('contacts')}}">{{\App\CPU\translate('contact_us')}}</a>
                        </li>
                        ...
                        <li class="widget-list-item "><a class="widget-list-link"
                            href="{{route('mission-vission')}}">{{\App\CPU\translate('mission & vision')}}</a>
                        </li>
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                @if(auth('customer')->check())
                    <ul class="widget-list" style="padding-bottom: 10px">
                        ...
                        <li class="widget-list-item">
                            <a class="widget-list-link"
                               href="{{route('shop.apply')}}">{{\App\CPU\translate('Seller Register')}}
                            </a>
                        </li>
                        ...
                        <li class="widget-list-item"><a class="widget-list-link"
                            href="{{route('returnRefund')}}">{{\App\CPU\translate('return & refund policy')}}</a>
                        </li>
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <ul class="widget-list" style="padding-bottom: 10px">
                    ...
                    @endif
                    <li class="widget-list-item">
                        <a class="widget-list-link" href="{{route('sellers')}}">{{\App\CPU\translate('sellers')}}</a>
                    </li>
                    <li class="widget-list-item"><a class="widget-list-link"
