<div class="feature_header setionMarginBottom">
...
<div class="row">
    <!-- List of items-->
    <section class="col-lg-8 PaddingRight">
        <div class="cart_information setionMarginBottom">
...
<script type="text/javascript">
    function initialCheckoutProcess (data) {
        // console.log('initialCheckoutProcess', data);
