...
<header class="box-shadow-sm rtl">
      <!-- Search-->
      <div class="input-group-overlay d-md-none">
        <form action="{{route('products')}}" type="submit" class="search_form">
            ...
            <diV class="card search-card"
                ...
                <div class="navbar navbar-expand navbar-stuck-menu d-md-none my-1">
            <div class="container">
            <ul class="navbar-nav mobile-navbar-nav d-flex" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                            <a class="nav-link" href="{{route('home')}}">{{ \App\CPU\translate('Home')}}</a>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="nav-link text-capitalize" href="{{ route('products', ['data_from' => 'best-selling', 'page' => 1]) }}">{{ \App\CPU\translate('Deals')}}</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link text-capitalize" href="{{ route('products', ['data_from' => 'latest', 'page' => 1]) }}">{{ \App\CPU\translate('New Arrival Gift Cards')}}</a>
                        </li>

                 
                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                            <a class="nav-link" href="{{route('sellers')}}">{{ \App\CPU\translate('Best Sellers')}}</a>
                        </li>

                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                            <a class="nav-link" href="{{route('seller.auth.login')}}"> {{ \App\CPU\translate('Sell on')}} {{ \App\CPU\translate('Ovendar')}} </a>
                        </li>
        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu">
            <div class="container">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <!-- Primary menu-->
                    <ul class="navbar-nav nav-top" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                            <a class="nav-link" href="{{route('home')}}">{{ \App\CPU\translate('Home')}}</a>
                        </li>
