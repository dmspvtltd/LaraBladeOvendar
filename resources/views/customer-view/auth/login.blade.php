                        ...
                        <form class="needs-validation mt-2" autocomplete="off" action="{{route('customer.auth.login')}}"
                            ...
                            <div class="form-group d-flex flex-wrap justify-content-between">
                                ...
                                <button class="btn btn-primary btn-block btn-shadow"
                                     type="submit">{{\App\CPU\translate('sign_in')}}
                                </button>
                                ...
                                @if (isset($socialLoginService) && $socialLoginService['status'] == true)
                                    <div class="col-sm-6 text-center">
                                        <a class="btn btn-outline-primary"
                                            ...
                                            style="width: 100%">
                                            <i
                                                class="czi-{{ $socialLoginService['login_medium'] }} mr-2 ml-n1"></i>{{ \App\CPU\translate('sing_in_with_' . $socialLoginService['login_medium']) }}
                                        </a>
                                    </div>
                                @endif
                            @endforeach
                                ...
                                <p class="mb-1 {{ Session::get('direction') === 'rtl' ? 'ml-2' : '' }}">
                                    <a class="btn btn-outline-primary mt-3" href="{{ route('customer.auth.register') }}" style="width: 100%">
