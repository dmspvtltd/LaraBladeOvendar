...
@push('css_or_js')
    ...
    <meta property="og:description" content="Nillgiri is a Bangladeshi Ecommerce marketplace, Nillgiri Launched in 1 may 2022. Nillgiri has been running since 1 June 2022. Nillgiri has started the journey with 4 partners. Nillgiri is a multitevender ecommerce company. All legal products can be traded here.">

    <meta property="twitter:card" content="Welcome to nillgiri"/>
    <meta property="twitter:title" content="Welcome to nillgiri"/>
    <meta property="twitter:url" content="https://www.nillgiri.com">
    <meta property="twitter:description" content="Nillgiri is a Bangladeshi Ecommerce marketplace, Nillgiri Launched in 1 may 2022. Nillgiri has been running since 1 June 2022. Nillgiri has started the journey with 4 partners. Nillgiri is a multitevender ecommerce company. All legal products can be traded here.">
...
@section('content')
            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h1 class="h3 text-dark mb-3 headerTitle text-uppercase categoruPaddingL">
    ...
    <div class="container rtl"
        ...
        <div class="row">
            ...
            <!-- Content  -->
            <section class="col-lg-9 categoruPaddingL">
                @if (count($products) > 0)
