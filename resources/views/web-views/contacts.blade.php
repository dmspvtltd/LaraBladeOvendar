...
@section('content')
    ...
    <div class="container">
      <div class="setionPaddingTop3">
        <div class="row contactDiv">
          <div class="col-6 col-lg-4 col-md-4 col-sm-4 ContactInfo">
            <div class="iconTitle">
              <i class="fa fa-phone fa-2x mr-3"></i>
              <span>Phone</span>
            </div>
            <div class="ContactText">
              <span>01722-441150</span>
          ...
          <div class="col-6 col-lg-4 col-md-4 col-sm-4 ContactInfo">
            ...
            <div class="ContactText">
              <span>Dhaka, Uttara, <br> sector 6, house 10</span>
              <!-- <span>018285464</span> -->
            </div>
          </div>
        </div>
