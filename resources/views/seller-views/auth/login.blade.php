    ...
    <main id="content" role="main" class="main"
        ...
        <div class="container py-5 py-sm-7">
            ...
            <a class="d-flex justify-content-center mb-5" href="javascript:">
                <img class="z-index-2" src="{{ asset('storage/app/public/company/' . $e_commerce_logo) }}"
                        ...
                        <div class="card-body">
                            ...
                            <form id="form-id" action="{{ route('seller.auth.login') }}" method="post">
                                ...
                                <div class="js-form-message form-group">
                                    <label class="input-label"
                                        for="signinSrEmail">{{ \App\CPU\translate('your_email_/_number') }}</label>

                                    <input type="text" class="form-control form-control-lg" name="email"
                                        id="signinSrEmail"
                                        style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
                                        tabindex="1" placeholder="Please input email/phone" aria-label="email@address.com"
                                ...
                                <div class="js-form-message form-group">
                                    <label class="input-label" for="signupSrPassword" tabindex="0">
                                        <span class="d-flex justify-content-between align-items-center"
                                            ...
                                            <a href="{{ route('seller.auth.forgot-passwordd') }}">
                            ...
                            <div class="text-center"> <br>
                                <a class="text-success"
                                    href="{{ route('shop.apply') }}">{{ \App\CPU\translate('If do no have any account! Apply Here') }}</a>
                            </div>
                            <!-- End Form -->
                        </div>
