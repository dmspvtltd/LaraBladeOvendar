    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="nid_number" id="nid_number"
                                        ...
                                        placeholder="{{ \App\CPU\translate('Enter your NID Number') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-9" id="">
                                    <div class="custom-file">
                                        @if ($data->nid_front)
                                            <a href="{{ asset('storage/app/public/seller') }}/{{ $data->nid_front }}">NID
                                                Front Page Preview</a>
                                            <br>
                                        @endif
                                        <input type="file" name="nid_front" id="" class=""
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="" for="">{{ \App\CPU\translate('NID Front Page ') }}
                                            {{ \App\CPU\translate('Upload') }}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-9" id="">
                                    <div class="custom-file">
                                        @if ($data->nid_back)
                                            <a href="{{ asset('storage/app/public/seller') }}/{{ $data->nid_back }}">NID
                                                Back
                                                Page Preview</a>
                                            <br>
                                        @endif
                                        <input type="file" name="nid_back" id="" class=""
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="" for="">{{ \App\CPU\translate('NID Back Page') }}
                                            {{ \App\CPU\translate('Upload') }}</label>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    <div class="card-header">
                        <h4 class="card-title">{{ \App\CPU\translate('Change') }} {{ \App\CPU\translate('Shop') }}
                            {{ \App\CPU\translate('Image') }}</h4>
                    </div>

                    <!-- Body -->
                    <div class="card-body">
                        <!-- Form -->
                        <form id="changeShopImage" action="{{ route('seller.profile.shop_image.update') }}"
                            method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-9" id="">
                                    <div class="custom-file">
                                        @if ($shopData->image)
                                            <a href="{{ asset('storage/app/public/shop') }}/{{ $shopData->image }}">Shop image</a>
                                            <br>
                                        @endif
                                        <input type="file" name="shop" id="" class=""
                                               accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="" for="">{{ \App\CPU\translate('Shop Image ') }}
                                            {{ \App\CPU\translate('Upload') }}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-9" id="">
                                    <div class="custom-file">
                                        @if ($shopData->banner)
                                            <a href="{{ asset('storage/app/public/shop/banner') }}/{{ $shopData->banner }}">Shop banner image</a>
                                            <br>
                                        @endif
                                        <input type="file" name="banner" id="" class=""
                                               accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="" for="">{{ \App\CPU\translate('Shop Banner Image') }}
                                            {{ \App\CPU\translate('Upload') }}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                    onclick="{{ env('APP_MODE') != 'demo' ? "form_alert('changeShopImage','Want to update image ?')" : 'call_demo()' }}"
