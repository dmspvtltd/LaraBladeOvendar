...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{route('admin.product.store-seller-product')}}" method="POST"
                    ...
                    <div class="card mt-2 mb-2 rest-part">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="name">{{\App\CPU\translate('Select Seller')}}</label>
                                        <select
                                            class="js-example-basic-multiple js-states js-example-responsive form-control"
                                            name="seller_id" required>
                                            <option value="{{null}}" selected disabled>---{{\App\CPU\translate('Select seller')}}---</option>
                                            @foreach($sellers as $seller)
                                                <option value="{{$seller->id}}">{{$seller->selleruid}}--{{$seller->shop_name}}--{{$seller->f_name.' '.$seller->l_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
