            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.sellers.view',$seller->id)}}" class="btn btn-primary">Back To Account & Settings</a>
                    </div>
                    <div class="card-body application-form">
                        <form action="{{ route('admin.sellers.shop.update', [$shop->id]) }}" method="post"
