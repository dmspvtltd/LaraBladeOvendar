                                        ...
                                        <td class="d-flex">
                                            <a class="btn btn-primary mr-1"
                                             ...
                                             @if($seller->status !== 'approved')
                                                {{-- href="{{route('sellers.seller.destroy',$seller->id)}}"> --}}
                                                    <form action="{{ route('admin.sellers.seller.destroy', $seller->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                        @csrf
                                                        @method('DELETE')
