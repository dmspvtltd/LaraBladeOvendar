                ...
                <div class="table-responsive">
                    <table id="datatable"
                        ...
                        @foreach($transactions as $key=>$transaction)
                            <tr class="{{ $transaction->status == 'requested' ? 'text-warning': ($transaction->status == 'pending' ? 'text-info':'text-success') }}">
                                ...
                                <td>
                                    {{ $transaction->customer?$transaction->customer->f_name:$transaction->customer_id}} {{ $transaction->customer?$transaction->customer->l_name:'' }}
                                </td>
                                ...
                                <td>
                                   @if ($transaction['status'] == 'requested')
                                        <form action="{{ route('admin.transaction.transaction-status-update', $transaction) }}" method="POST">
                                        @csrf
                                        <button class="btn btn-primary btn-sm" name="status" value="disburse" type="submit">Accept</button>
                                        <button class="btn btn-danger btn-sm" name="status" value="rejected" type="submit">Reject</button>
                                    </form>
                                   @endif
                                </td>
                            </tr>
