...
Route::group(['namespace' => 'Seller', 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::get('recover-password', 'ForgotPasswordController@reset_password')->name('forgot-passwordd');
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        Route::group(['prefix' => 'transaction', 'as' => 'transaction.'], function () {
            ...
            Route::post('generate', 'TransactionController@make_invoice')->name('generate-invoice');
        });
        ...
        Route::group(['prefix' => 'payment', 'as' => 'payment.'], function () {
            Route::get('dues', 'PaymentController@due')->name('due');
        });  
        ...
        Route::group(['prefix' => 'profile', 'as' => 'profile.'], function () {
            ...
            Route::post('shop-image-update', 'ProfileController@shop_image_update')->name('shop_image.update');
