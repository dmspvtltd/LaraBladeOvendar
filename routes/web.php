...
Route::get('test/{order}', function (Order $order) {
    return Helpers::sales_commission($order);
});
...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode']], function () {
    ...
    Route::get('mission-vission', 'WebController@missionvission')->name('mission-vission');
    Route::get('disclaimer', 'WebController@disclaimer')->name('disclaimer');
    Route::get('returnRefund', 'WebController@returnRefund')->name('returnRefund');    
    

    Route::get('/product/{slug}', 'WebController@product')->name('product');
    Route::get('products', 'WebController@products')->name('products');
    
    Route::get('fashions', 'WebController@fashions')->name('fashions');
...
Route::group(['prefix' => 'shop', 'as' => 'shop.', 'namespace' => 'Seller\Auth'], function () {
    ...
    Route::get('check/{id}', 'RegisterController@check')->name('seller.check');
    Route::post('verify', 'RegisterController@verify')->name('seller.verify');
});
