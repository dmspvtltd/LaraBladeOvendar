...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.','middleware'=>['module:user_section']], function () {
            ...
            Route::get('shop/edit/{id}', 'SellerController@sellerEdit')->name('shop.edit');
            Route::post('shop/update/{id}', 'SellerController@sellerUpdate')->name('shop.update');
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('add-new-seller-product', 'ProductController@add_new_seller_product')->name('add-new-seller-product');
            Route::post('store-seller-product', 'ProductController@store_seller_product')->name('store-seller-product');
            ...
            Route::post('free_delivery-status', 'ProductController@free_delivery_status')->name('free_delivery-status');
        ...
        Route::group(['prefix' => 'transaction', 'as' => 'transaction.' ,'middleware'=>['module:business_section']], function () {
            ...
            Route::post('status/update/{transaction}', 'TransactionController@statusUpdate')->name('transaction-status-update');
        });
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::post('approved/status', 'OrderController@approvedStatus')->name('approved.status');
